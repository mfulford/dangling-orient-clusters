...
public:
	...
	std::vector<int> getqllCrystalTopVec() const {return qllCrystalTop;};
	std::vector<int> getqllCrystalBotVec() const {return qllCrystalBot;};
	std::vector<int> getqllLiquidTopVec() const {return qllLiquidTop;};
	std::vector<int> getqllLiquidBotVec() const {return qllLiquidBot;};

	std::vector<int> getqllTopVec() const {return qllTop;};
	std::vector<int> getqllBotVec() const {return qllBot;};
	...
	void qlloxygens(const std::vector<int> & ,const float*, const float, const float);
